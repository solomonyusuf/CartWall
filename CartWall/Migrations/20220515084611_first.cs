    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectProduct", x => x.CollectId);
                    table.ForeignKey(
                        name: "FK_CollectProduct_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Card_OrderId",
                table: "Card",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectProduct_ShoppingCartId",
                table: "CollectProduct",
